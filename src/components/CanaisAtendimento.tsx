...
export default function CanaisAtendimento() {
  ...
  return (
    <section id="contatos-rapidos" className="relative bg-zinc-950 py-12 sm:py-16 overflow-hidden z-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-zinc-900/50 p-6 sm:p-10 rounded-2xl border border-white/5 shadow-2xl relative overflow-hidden">

          {/* Background subtle glowing effect */}
          <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-[#FFD400]/4 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -left-20 -top-20 w-80 h-80 bg-white/2 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 relative z-10">
            ...
            <motion.div
              ...
              className="bg-zinc-950 text-white p-6 sm:p-8 rounded-xl border border-red-900/40 hover:border-red-500/60 shadow-lg hover:shadow-[0_0_32px_rgba(220,38,38,0.18)] flex flex-col items-center text-center justify-between min-h-[280px] hover:-translate-y-1.5 hover:scale-[1.02] transition-all duration-300 group"
            >
              <div className="flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-red-600 flex items-center justify-center mb-4 shadow-lg shadow-red-900/40">
              ...
              <button
                ...
                className="mt-6 w-full py-2.5 px-4 min-h-[44px] bg-red-600 hover:bg-red-500 text-white font-black text-xs uppercase tracking-widest rounded-lg shadow transition-colors cursor-pointer flex items-center justify-center"
              >
                Chamar no WhatsApp
              </button>
            </motion.div>
